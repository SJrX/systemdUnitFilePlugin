...
class InvalidValueInspectionForCPUWeight : AbstractUnitFileTest() {
  ...
  fun testWeakWarningWhenZeroIsSpecified() {
    ...
    assertStringContains("CPUWeight's value is correctly formatted but seems invalid", info!!.description)
